#ifndef SHIFT_ONSET_GRAIN_HPP
#define SHIFT_ONSET_GRAIN_HPP
...
class Shift_onset_grain
{
    public:
        Shift_onset_grain() { reset(); }
        ~Shift_onset_grain() = default;
