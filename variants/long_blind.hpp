#ifndef SHIFT_LONG_BLIND_HPP
#define SHIFT_LONG_BLIND_HPP
...
class Shift_long_blind
{
    public:
        Shift_long_blind() { reset(); }
        ~Shift_long_blind() = default;
