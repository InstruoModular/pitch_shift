#ifndef SHIFT_MIN_PERIOD_HPP
#define SHIFT_MIN_PERIOD_HPP
...
class Shift_min_period
{
    public:
        Shift_min_period() { reset(); }
        ~Shift_min_period() = default;
