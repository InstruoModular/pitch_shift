#ifndef SHIFT_XLONG_BLIND_HPP
#define SHIFT_XLONG_BLIND_HPP
...
class Shift_xlong_blind
{
    public:
        Shift_xlong_blind() { reset(); }
        ~Shift_xlong_blind() = default;
    ...
    private:
        ...
        static constexpr float default_grain = 2304.f; /* E4a: was 1536 (E3b), 768 originally */   // when no pitch is found
