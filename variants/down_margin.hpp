#ifndef SHIFT_DOWN_MARGIN_HPP
#define SHIFT_DOWN_MARGIN_HPP
...
class Shift_down_margin
{
    public:
        Shift_down_margin() { reset(); }
        ~Shift_down_margin() = default;
