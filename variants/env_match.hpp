#ifndef SHIFT_ENV_MATCH_HPP
#define SHIFT_ENV_MATCH_HPP
...
class Shift_env_match
{
    public:
        Shift_env_match() { reset(); }
        ~Shift_env_match() = default;
