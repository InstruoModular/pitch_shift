#ifndef SHIFT_BLIND_MARGIN_HPP
#define SHIFT_BLIND_MARGIN_HPP
...
class Shift_blind_margin
{
    public:
        Shift_blind_margin() { reset(); }
        ~Shift_blind_margin() = default;
