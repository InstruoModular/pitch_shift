#ifndef SHIFT_LONG_BLIND_SPAN_HPP
#define SHIFT_LONG_BLIND_SPAN_HPP
 ...
 */
namespace shift_long_blind_span
{
...
class Shift_long_blind_span
{
    public:
        Shift_long_blind_span() { reset(); }
        ~Shift_long_blind_span() = default;
...
#endif // SHIFT_LONG_BLIND_SPAN_HPP
